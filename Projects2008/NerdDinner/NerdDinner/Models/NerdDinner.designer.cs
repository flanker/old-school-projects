...
namespace NerdDinner.Models
{
    ...
    partial void DeleteRSVP(RSVP instance);
		...
		public IQueryable<NearestDinners_个结果> NearestDinners([Parameter(DbType="Real")] System.Nullable<float> lat, [Parameter(Name="long", DbType="Real")] System.Nullable<float> @long)
		{
			return this.CreateMethodCallQuery<NearestDinners_个结果>(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), lat, @long);
		}
	}
	
	[Table(Name="dbo.Dinner")]
	...
	public partial class NearestDinners_个结果
	{
		
		private int _DinnerID;
		
		public NearestDinners_个结果()
		{
		}
