...
namespace kaogu_0730.Module
{
    ...
    public class Layer : BaseObject
    {
        ...
        {
            get {
                if (GetPropertyValue<Accumulation>("Accumulation") != null)
                { return GetPropertyValue<Accumulation>("Accumulation").ToString(); }
                else if (GetPropertyValue<ExcavationTrench>("ExcavationTrench") != null)
                { return GetPropertyValue<ExcavationTrench>("ExcavationTrench").ToString(); }
