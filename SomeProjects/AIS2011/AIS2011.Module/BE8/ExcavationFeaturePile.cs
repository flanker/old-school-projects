...
namespace kaogu_0730.Module
{
    ...
    public class ExcavationFeaturePile : BaseObject
    {
        ...
        //出土物
        [Custom("Caption", "地表建筑-出土物")]

        [Association("ExcavationFeaturePile-RemainMark1", typeof(RemainMark))]
        ...
        //注意：概述下部建筑形状、体量、各层堆积情况及特殊建筑结构和人工遗迹现象；
        //列举理由推断堆状遗迹的建筑方式及堆积形成的过程。
        [Size(3000)]
        [Custom("Caption","描述")]
        ...
        //出土物
        [Custom("Caption", "下部建筑-出土物")]

        [Association("ExcavationFeaturePile-RemainMark2", typeof(RemainMark))]
