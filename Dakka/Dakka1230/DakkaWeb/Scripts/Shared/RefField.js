...
Ext.form.ShiftDefRefField = Ext.extend(Ext.form.TriggerField, {
    ...
    initComponent: function() {
        ...
        this.ds = new Ext.data.Store({
            proxy: new Ext.data.HttpProxy({ url: '../Shift/GetSome', method: 'GET' }),
            reader: new Ext.data.JsonReader({ totalProperty: 'totalProperty', root: 'root', id: 'id' },
...
// 工作日历 **********************************************************************************************
Ext.form.WorkCalendarRefField = Ext.extend(Ext.form.TriggerField, {
    ...
    initComponent: function() {
        Ext.form.ComboBox.superclass.initComponent.call(this);
        this.ds = new Ext.data.Store({
            proxy: new Ext.data.HttpProxy({ url: '../WorkCalendar/GetSome', method: 'GET' }),
            reader: new Ext.data.JsonReader({ totalProperty: 'totalProperty', root: 'root', id: 'id' },
                [{ name: 'ID' }, { name: 'Code' }, { name: 'Name' }, { name: 'Description' }, { name: 'FromDate' }, { name: 'ToDate'}])
        });
        this.ButtonOK = new Ext.Button({ text: 'OK', tooltip: 'OK', iconCls: 'add' });
        this.sm = new Ext.grid.CheckboxSelectionModel();
        this.cm = new Ext.grid.ColumnModel([
