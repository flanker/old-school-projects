...
Ext.DetailPanel = Ext.extend(Ext.Panel, {
        ...
        Ext.apply(this, {
            tbar: new Ext.Toolbar({
                items: [{ id: 'ButtonNew', text: 'New', tooltip: 'Add new shift', iconCls: 'new', handler: this.Panel_New_Click, scope: this },
                    ...
                    '-',
                    { id: 'ButtonPageFirst', text: 'First', tooltip: 'First page', iconCls: 'pageFirst', handler: this.Panel_First_Click, scope: this },
                    '-',
                    { id: 'ButtonPagePrev', text: 'Prev', tooltip: 'Prev page', iconCls: 'pagePrev', handler: this.Panel_Prev_Click, scope: this },
                    '-',
                    { id: 'ButtonPageNext', text: 'Next', tooltip: 'Next page', iconCls: 'pageNext', handler: this.Panel_Next_Click, scope: this },
                    '-',
                    { id: 'ButtonPageLast', text: 'Last', tooltip: 'Last page', iconCls: 'pageLast', handler: this.Panel_Last_Click, scope: this}]
            })
        });
        if (this.processID != '0') {
            this.LoadData();
    ...
    Panel_First_Click: function() {
        this.Panel_Nav(0);
    },
    Panel_Prev_Click: function() {
        this.Panel_Nav(1);
    },
    Panel_Next_Click: function() {
        this.Panel_Nav(2);
    },
    Panel_Last_Click: function() {
        this.Panel_Nav(3);
    },
    Panel_Nav: function(type) {
        var pages = eval(this.navPages);
        if (pages != null && pages[type] != 0) {
            window.location.href = 'Detail?ID=' + pages[type];
        }
    },
