...
parseDateTimeFunction(node.getElementsByTagName("Start")[0].firstChild.nodeValue),
parseDateTimeFunction(node.getElementsByTagName("End")[0].firstChild.nodeValue),
null,
null,
true,
node.getElementsByTagName("Title")[0].firstChild.nodeValue,
node.getElementsByTagName("Id")[0].firstChild.nodeValue,
this._resolveRelativeURL(null, base),
this._resolveRelativeURL(null,base),
this._resolveRelativeURL(null,base),
null,
null
...
Timeline.DefaultEventSource.prototype.loadXML2=function(xml,url){
var base=this._getBaseURL(url);
