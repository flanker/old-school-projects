...
Timemap.prototype.goEvent = function(i) {
    ...
    this._tlEventSource.getEvent(i)._icon = 'green-circle.png';
...
Timemap.YellowMarkerImage = new google.maps.MarkerImage('yellow_marker_sprite.png',
      new google.maps.Size(20, 32),
      new google.maps.Point(0, 0),
      new google.maps.Point(10, 32));
Timemap.YellowMarkerShadow = new google.maps.MarkerImage('yellow_marker_sprite.png',
